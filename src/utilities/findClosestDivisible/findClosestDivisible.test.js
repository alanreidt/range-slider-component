...
export function testFindClosestDivisible() {
  describe("findClosestDivisible", () => {
    ...
    describe("shall take into account start", () => {
      ...
      starting from 30 is equal to 230`, () => {
        assert.deepEqual(findClosestDivisible(250, 100, 30), 230);
      });

      it(`nearest divisible number for division of 280 by 100,
      starting from 30 is equal to 330`, () => {
        assert.deepEqual(findClosestDivisible(280, 100, 30), 330);
      });

      it(`nearest divisible number for division of 300 by 100,
      starting from 30 is equal to 330`, () => {
        assert.deepEqual(findClosestDivisible(300, 100, 30), 330);
      });

      it(`nearest divisible number for division of 0 by 100,
      starting from 30 is equal to 30`, () => {
        assert.deepEqual(findClosestDivisible(0, 100, 30), 30);
      });

      it(`nearest divisible number for division of 100 by 100,
      starting from 30 is equal to 130`, () => {
        assert.deepEqual(findClosestDivisible(100, 100, 30), 130);
      });

      it(`nearest divisible number for division of -220 by 100,
      starting from -403 is equal to -203`, () => {
        assert.deepEqual(findClosestDivisible(-220, 100, -403), -203);
      });

      it(`nearest divisible number for division of -253 by 100,
      starting from -403 is equal to -203`, () => {
        assert.deepEqual(findClosestDivisible(-253, 100, -403), -203);
      });

      it(`nearest divisible number for division of -280 by 100,
      starting from -403 is equal to -303`, () => {
        assert.deepEqual(findClosestDivisible(-280, 100, -403), -303);
      });

      context("handles when start property is end", () => {
        it(`nearest divisible number for division of 220 by 100,
        starting from 530 is equal to 230`, () => {
          assert.deepEqual(findClosestDivisible(220, 100, 530), 230);
        });

        it(`nearest divisible number for division of 280 by 100,
        starting from 530 is equal to 230`, () => {
          assert.deepEqual(findClosestDivisible(280, 100, 530), 330);
        });

        it(`nearest divisible number for division of 300 by 100,
        starting from 530 is equal to 330`, () => {
          assert.deepEqual(findClosestDivisible(300, 100, 530), 330);
        });

        it(`nearest divisible number for division of -220 by 100,
        starting from -3 is equal to -203`, () => {
          assert.deepEqual(findClosestDivisible(-220, 100, -3), -203);
        });

        it(`nearest divisible number for division of -253 by 100,
        starting from -3 is equal to -203`, () => {
          assert.deepEqual(findClosestDivisible(-253, 100, -3), -203);
        });

        it(`nearest divisible number for division of -280 by 100,
        starting from -3 is equal to -303`, () => {
          assert.deepEqual(findClosestDivisible(-280, 100, -3), -303);
        });

        it(`nearest divisible number for division of -150 by 100,
        starting from 70 is equal to -130`, () => {
          assert.deepEqual(findClosestDivisible(-150, 100, 70), -130);
        });

        it(`nearest divisible number for division of -180 by 100,
        starting from 70 is equal to -130`, () => {
          assert.deepEqual(findClosestDivisible(-180, 100, 70), -130);
        });

        it(`nearest divisible number for division of -220 by 100,
        starting from 70 is equal to -230`, () => {
          assert.deepEqual(findClosestDivisible(-220, 100, 70), -230);
        });
      });
    });
