...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=t(require("./SliderFactory"));function t(e){return e&&e.__esModule?e:{default:e}}var r={_factory:e.default,_parentsMap:new WeakMap,create:function(e,t){var r=this._factory.createModel(t),a=this._factory.createViewController(e,r),s=a.setElements.bind(a);r.addSubscriber("update",s),this._parentsMap.set(e,{model:r,viewController:a})},getOptions:function(e){return this._parentsMap.get(e).model.getOptions()},setOptions:function(e,t){this._parentsMap.get(e).model.setOptions(t)},setValueAt:function(e,t,r){this._parentsMap.get(e).model.setValueAt(t,r)}},a=r;exports.default=a;
